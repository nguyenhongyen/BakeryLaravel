                        ...
                        <div class="col-md-3">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="percent_sale" value="{{ $product->percent_sale   }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('uploads/img/'.$product->image) }}" width="100" alt="{{ $product->image }}">
                                </div>
                                <div id="display_image"></div>
                                <div class="form-group">
                                    <label for="images">Hình ảnh liên quan</label>
                                    <input type="file" value={{$product->list_image  }}class="form-control" name="images[]" id="images"
